 ...
 * Original file: /npm/@tailwindcss/browser@4.2.2/dist/index.global.js
 *
...
(() => {
    ...
    var d = class {
                ...
                for (let [n, o] of this.values)
                    n === e
                        ...
                        : n.startsWith(`${r}-`)
                          ...
                          : n.startsWith(r) &&
                            t.set(n.slice(r.length), o.value);
                return t;
            }
            addKeyframes(e) {
        ...
        f = class extends Map {
            ...
            get(e) {
                ...
                return (
                    void 0 === t &&
                        ((t = this.factory(e, this)), this.set(e, t)),
                    t
                );
            }
        };
    ...
    function N(e) {
        return {
            ...
            get context() {
                ...
                return (
                    Object.defineProperty(this, "context", { value: t }),
                    t
                );
            },
            get parent() {
        ...
        function p(e, f, h = {}, m = 0) {
            if ("declaration" === e.kind) {
                ...
                if ("animation" === e.property)
                    for (let t of R(e.value)) s.add(t);
                (2 & r &&
                        ...
                        (y(o, (e) => {
                            ...
                            if (
                                ...
                                let t = e.nodes.findIndex(
                                    (e) =>
                                        "separator" === e.kind &&
                                        e.value.trim().includes(","),
                                );
                                if (-1 === t) return;
                                let r =
                                    e.nodes.length > t ? e.nodes[t + 1] : null;
    ...
    var oe = new f((e) => {
        let t = v(e);
        return (
            1 === t.length && "function" === t[0].kind && "var" === t[0].value
        );
    });
    function ie(e) {
        return oe.get(e);
    ...
    var de = {
        color: function (e) {
            return (
                35 === e.charCodeAt(0) || ue.test(e) || ce.has(e.toLowerCase())
            );
        },
        length: ze,
        percentage: ye,
                              ...
                              return (
                                  y(e.nodes, (e) => {
                                      ...
                                      for (let r of e.nodes)
                                          if ("word" === r.kind)
                                              if ("integer" === r.value)
                                                  n[t].usedSpacingInteger ||=
                                                      !0;
                                              else if (
                                                  "number" === r.value &&
                                                  ((n[t].usedSpacingNumber ||=
                                                      !0),
                                                  n["--modifier"]
                                                      .usedSpacingNumber &&
                                                      n["--value"]
            ...
            a = Oe(t, (e) =>
                null == r
                    ...
                    : e.startsWith("current")
                      ? n(Re(e, r))
                      : ((e.startsWith("var(") || r.startsWith("var(")) &&
                            (i = !0),
                        n(De(e, r))),
            );
        function l(e) {
        ...
        y(e, (e) =>
            "at-rule" === e.kind && "@slot" === e.name
                ...
                : "at-rule" !== e.kind ||
                  ...
                  ? void 0
                  : (Object.assign(e, K([S(e.name, e.params, e.nodes)])),
                    b.Skip),
        );
    }
    function mt(e, t) {
        ...
        return (
            y(e, (e) => {
                ...
                if (null === i)
                    throw new Error(
                        `Cannot use \`@variant\` with unknown variant: ${o}`,
                    );
                if (null === wt(n, i, t.variants))
                    throw new Error(
                        `Cannot use \`@variant\` with variant: ${o}`,
                    );
        ...
        let r = (function (e) {
                ...
                function o(n, o) {
                    ...
                    if (
                        ...
                        o.staticValues &&
                            Object.keys(o.staticValues).length > 0)
                    ) {
                ...
                for (let [e, t, r] of [
                    ...
                    [
                        "min-h",
                        ["--min-height", "--height", "--spacing"],
                        "min-height",
                    ],
                    [
                        "max-h",
                        ["--max-height", "--height", "--spacing"],
                        "max-height",
                    ],
                ])
                ...
                function d({ negative: t }) {
                    return (r) => {
                        ...
                        if ("arbitrary" === r.value.kind) {
                            n = r.value.value;
                            let e =
                                r.value.dataType ?? fe(n, ["angle", "vector"]);
                            if ("vector" === e)
                                return [j("rotate", `${n} var(--tw-rotate)`)];
                            if ("angle" !== e)
                ...
                let p = () =>
                    K([We("--tw-scroll-snap-strictness", "proximity", "*")]);
                ...
                (n("grid-flow-row", [["grid-auto-flow", "row"]]),
                    ...
                    a("gap-x", ["--gap", "--spacing"], (e) => [
                        j("column-gap", e),
                    ]),
                    a("gap-y", ["--gap", "--spacing"], (e) => [
                        j("row-gap", e),
                    ]),
                    a(
                        "space-x",
                    ...
                    ]));
                {
                    ...
                    (i("border", {
                        ...
                        o("divide-x", {
                            defaultValue:
                                e.get(["--default-border-width"]) ?? "1px",
                        ...
                        if ("arbitrary" === t.value.kind) {
                            ...
                            switch (
                                ...
                                case "url":
                                    return t.modifier
                                        ? void 0
                                        : [j("background-image", r)];
                                default:
                                    return (
                                        (r = _e(r, t.modifier, e)),
                                        null === r
                                            ? void 0
                                            : [j("background-color", r)]
                                    );
                            }
                        }
                        {
                            ...
                            for (let o of ["top", "right", "bottom", "left"])
                                r[o] &&
                                    ...
                                    n.push(
                                        K([
                                            We(
                                                `--tw-mask-${o}-from-position`,
                                                "0%",
                                            ),
                                            We(
                                                `--tw-mask-${o}-to-position`,
                                                "100%",
                                            ),
                                            We(
                                                `--tw-mask-${o}-from-color`,
                                                "black",
                                            ),
                                            We(
                                                `--tw-mask-${o}-to-color`,
                    ...
                    }));
                {
                    ...
                    (t.functional("filter", (e) => {
                        ...
                        t.functional("drop-shadow", (t) => {
                            ...
                            {
                                let n = e.get([
                                        `--drop-shadow-${t.value.value}`,
                                    ]),
                                    o = e.resolve(t.value.value, [
                                        "--drop-shadow",
                                    ]);
                                if (n && o)
                                    return t.modifier && !r
                            ...
                            t.functional("duration", (t) => {
                                ...
                                return (
                                    "arbitrary" === t.value.kind
                                        ? (n = t.value.value)
                                        : ((n = e.resolve(
                                              t.value.fraction ?? t.value.value,
                                              ["--transition-duration"],
                                          )),
                                          null === n &&
                                              Ce(t.value.value) &&
                    ...
                    (t.static("outline-hidden", () => [
                        ...
                        t.functional("outline", (t) => {
                            if (null === t.value) {
                                if (t.modifier) return;
                                let r =
                                    e.get(["--default-outline-width"]) ?? "1px";
                                return [
                                    i(),
                                    j(
                                        "outline-style",
                ...
                (o("opacity", {
                    ...
                    o("underline-offset", {
                        ...
                        staticValues: {
                            auto: [j("text-underline-offset", "auto")],
                        },
                    }),
                    r("underline-offset", () => [
                        {
                                ...
                                if (r) {
                                    ...
                                    if (t.modifier) {
                                        let r =
                                            "arbitrary" === t.modifier.kind
                                                ? t.modifier.value
                                                : e.resolve(t.modifier.value, [
                                                      "--leading",
                                                  ]);
                                        if (!r && Te(t.modifier.value)) {
                                            let n = e.resolve(null, [
                                                "--spacing",
                                            ]);
                                            if (!n) return null;
            ...
            n = (function (e) {
                ...
                (t.compound("not", 3, (e, t) => {
                    ...
                    t.suggest("not", () =>
                        Array.from(t.keys()).filter((e) =>
                            t.compoundsWith("not", e),
                        ),
                    ),
                    t.compound("group", 2, (t, r) => {
                        if (
                            "arbitrary" === r.variant.kind &&
                            r.variant.relative
                        )
                            return null;
                        let n = r.modifier
                ...
                (r("first", ["&:first-child"]),
                    ...
                    t.functional("aria", (e, t) => {
                        ...
                        "arbitrary" === t.value.kind
                            ? (e.nodes = [
                                  A(`&[aria-${pt(t.value.value)}]`, e.nodes),
                              ])
                            : (e.nodes = [
                                  A(`&[aria-${t.value.value}="true"]`, e.nodes),
                              ]);
                    }),
                    t.suggest("aria", () => [
                        "busy",
                    ...
                    t.functional("nth-last", (e, t) => {
                        if (
                            ...
                            return null;
                        e.nodes = [
                            A(`&:nth-last-child(${t.value.value})`, e.nodes),
                        ];
                    }),
                    t.functional("nth-of-type", (e, t) => {
                        if (
                            ...
                            return null;
                        e.nodes = [
                            A(`&:nth-of-type(${t.value.value})`, e.nodes),
                        ];
                    }),
                    t.functional("nth-last-of-type", (e, t) => {
                        if (
                            ...
                            return null;
                        e.nodes = [
                            A(`&:nth-last-of-type(${t.value.value})`, e.nodes),
                        ];
                    }),
                    t.functional(
                        "supports",
            ...
            o = new f((e) =>
                (function (e, t) {
                    if ("[" === e[0] && "]" === e[e.length - 1]) {
                        ...
                        let t = M(e.slice(1, -1));
                        if (!q(t) || 0 === t.length || 0 === t.trim().length)
                            return null;
                        let r = ">" === t[0] || "+" === t[0] || "~" === t[0];
                        return (
                            !r &&
        ...
        let u = {
            ...
            resolveThemeValue(t, r = !0) {
                let n = t.lastIndexOf("/"),
                    o = null;
                -1 !== n &&
                    ((o = t.slice(n + 1).trim()), (t = t.slice(0, n).trim()));
            ...
            for (let r of n) {
                ...
                if (0 !== n.length) {
                    ...
                    for (let { node: t, propertySort: a } of n) {
                        ...
                        (o.set(t, { properties: a, variants: n, candidate: e }),
                            i.push(t));
                    }
                }
            }
                        ...
                        let r = kt(Object.keys(n), t, {
                                ...
                                onInvalidCandidate: (e) => {
                                    ...
                                    throw 0 === t.theme.size
                                        ...
                                        : new Error(
                                              `Cannot apply unknown utility class \`${e}\``,
                                          );
                                },
                            }),
                            o = e.src,
            ...
            y(e, (e) => {
                if (
                    ...
                    let s = (function (e) {
                        ...
                        return t
                            ? { uri: t, layer: r, media: n, supports: o }
                            : null;
                    })(v(e.params));
                    if (null === s) return;
                    ("@reference" === e.name && (s.media = "reference"),
                        (a |= 2));
            ...
            let r = 5;
            {
                ...
                n &&
                    ...
                    e.theme.add(
                        ...
                        St(t.fontFamily.sans, "fontFeatureSettings") ??
                            "normal",
                        r,
                    ),
                    e.theme.add(
                        "--default-font-variation-settings",
                        St(t.fontFamily.sans, "fontVariationSettings") ??
                            "normal",
                        r,
                    ));
            }
            {
                ...
                n &&
                    ...
                    e.theme.add(
                        ...
                        St(t.fontFamily.mono, "fontFeatureSettings") ??
                            "normal",
                        r,
                    ),
                    e.theme.add(
                        "--default-mono-font-variation-settings",
                        St(t.fontFamily.mono, "fontVariationSettings") ??
                            "normal",
                        r,
                    ));
            }
    ...
    function Bt(e, t, r) {
        return function (n, o) {
            let i = n.lastIndexOf("/"),
                a = null;
            -1 !== i &&
                ((a = n.slice(i + 1).trim()), (n = n.slice(0, i).trim()));
            let l = (() => {
                let o = _t(n),
                    [i, a] = (function (e, t) {
                ...
                if (null !== l && "object" == typeof l && !Array.isArray(l)) {
                    ...
                    if (null === i && Object.hasOwn(l, "__CSS_VALUES__")) {
                        let t = {};
                        for (let r in l.__CSS_VALUES__)
                            ((t[r] = l[r]), delete e[r]);
                        i = t;
                    }
                    for (let t in i)
                        "__CSS_VALUES__" !== t &&
                            ((4 & l?.__CSS_VALUES__?.[t] &&
                                void 0 !== It(e, t.split("-"))) ||
                                (e[s(t)] = i[t]));
                    return e;
                }
    ...
    function It(e, t) {
        for (let r = 0; r < t.length; ++r) {
            let n = t[r];
            if (null != e && "object" == typeof e && Object.hasOwn(e, n))
                e = e[n];
            else {
                        ...
                        e.variants.functional(t, (e, t) => {
                            ...
                            if ("arbitrary" === t.value.kind)
                                ...
                                if ("named" !== t.value.kind || !n?.values)
                                    return null;
                                {
                                    if (!Object.hasOwn(n.values, t.value.value))
                                        return null;
            ...
            matchUtilities(t, r) {
                ...
                for (let [i, a] of Object.entries(t)) {
                    let t = function ({ negative: t }) {
                        return (l) => {
                            ...
                            if (null === u) return;
                            {
                                ...
                                s = l.modifier
                                    ? "any" === e ||
                                      "arbitrary" === l.modifier.kind
                                        ? l.modifier.value
                                        : e &&
                                            Object.hasOwn(e, l.modifier.value)
                                          ? e[l.modifier.value]
                                          : c &&
                                              !Number.isNaN(
                                                  Number(l.modifier.value),
                                              )
                                            ? `${l.modifier.value}%`
                                            : null
                                    : null;
                    ...
                    (r?.supportsNegativeValues &&
                        e.utilities.functional(`-${i}`, t({ negative: !0 }), {
                            types: o,
                        }),
                        e.utilities.functional(i, t({ negative: !1 }), {
                            types: o,
                        }),
                        e.utilities.suggest(i, () => {
                            ...
                            (t.delete("__BARE_VALUE__"),
                                ...
                                t.has("DEFAULT") &&
                                    (t.delete("DEFAULT"), t.add(null)));
                            let n = r?.modifiers ?? {},
                                o = "any" === n ? [] : Object.keys(n);
                            return [
                                {
                                    supportsNegative:
                                        r?.supportsNegativeValues ?? !1,
                                    values: Array.from(t),
                                    modifiers: o,
                                },
                            ];
    ...
    function Zt(e) {
        let t = [],
            r = (e = Array.isArray(e) ? e : [e]).flatMap((e) =>
                Object.entries(e),
            );
        for (let [e, n] of r)
            if (null != n && !1 !== n)
        ...
        return {
            theme: {
                ...
                extend: {
                    ...
                    transitionDuration: {
                        DEFAULT:
                            e.get(["--default-transition-duration"]) ?? null,
                    },
                    transitionTimingFunction: {
                        DEFAULT:
                            e.get(["--default-transition-timing-function"]) ??
                            null,
                    },
    ...
    function fr(e, { config: t, base: r, path: n, reference: o, src: i }) {
        ...
        for (let t of s)
            e.content.files.push(
                "object" == typeof t ? t : { base: r, pattern: t },
            );
        e.configs.push(t);
    }
    function pr(e, t) {
        ...
        let n = (function ({ center: e, padding: t, screens: r }, n) {
            ...
            if ("object" == typeof t && null !== t) {
                let e = Object.entries(t)
                    ...
                    .map(([e, t]) => [
                        e,
                        n.theme.resolveValue(e, ["--breakpoint"]),
                        t,
                    ])
                    .filter(Boolean);
                ...
                for (let [t, , r] of e)
                    if (i && i.has(t))
                        i.get(t).nodes.push(j("padding-inline", r));
                    else {
                        if (i) continue;
                        o.push(
                            S("@media", `(width >= theme(--breakpoint-${t}))`, [
            ...
            (function (e) {
                ...
                (e.utilities.suggest("bg-left-top", () => []),
                    ...
                    e.utilities.functional("max-w-screen", (t) => {
                        ...
                        let r = e.theme.resolve(t.value.value, [
                            "--breakpoint",
                        ]);
                ...
                for (let [t, r] of [
                    ...
                    let n = function ({ negative: t }) {
                        return (n) => {
                            ...
                            let o = e.theme.resolve(
                                n.value.fraction ?? n.value.value,
                                ["--inset", "--spacing"],
                            );
    ...
    function kr({
        ...
        let a = 0,
            l = [
                ...i.map((e) => {
                    ...
                    throw new Error(
                        `The plugin "${e.path}" does not accept options`,
                    );
                }),
                ...o,
            ],
        ...
        for (let e of s.content.files) {
            ...
            let t = !1;
            ("!" == e.pattern[0] &&
                ((t = !0), (e.pattern = e.pattern.slice(1))),
                n.push({ ...e, negated: t }));
        }
        return a;
    }
        ...
        let o = n(t, { from: r.from }),
            i = await (async function (e, t = {}) {
                ...
                let u = new Set(),
                    ...
                    p = !1;
                for (let e of s)
                    r.invalidCandidates.has(e) || (u.add(e), (p = !0));
                return {
                    sources: o,
                    root: i,
                    features: l,
            ...
            buildSourceMap: () =>
                (function ({ ast: t }) {
                    ...
                    return (
                        o.mappings.sort(
                            (e, t) =>
                                e.generatedPosition.line -
                                    t.generatedPosition.line ||
                                e.generatedPosition.column -
                                    t.generatedPosition.column ||
    ...
    var Sr,
        ...
        Or = new (class {
            ...
            error(e) {
                throw (
                    performance.mark("(error)", { detail: { error: `${e}` } }),
                    e
                );
            }
        })();
            ...
            (Or.start(`Build #${t} (${e})`),
                "full" === e &&
                    (await (async function () {
                        (Or.start("Create compiler"),
                            Or.start("Reading Stylesheets"));
...
//# sourceMappingURL=/sm/cc6d109f45b866ae509f11bb3df9513f43ff721ab1f6512a1aa30898c4492317.map
