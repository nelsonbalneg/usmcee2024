            ...
            <div class="!px-10 !py-12 card-body">
                <a href="#!">
                    <img src="{{ asset('backend/assets/images/logo-light.png') }}" alt=""
                        class="hidden mx-auto h-15 dark:block">
                ...
                <div class="mt-8 text-center">
                    <p class="text-slate-500 dark:text-zink-200">
                        Forgot your password? No problem. Just let us know your registered email address and the last
                        four digits of your registered phone number (e.g., ****-***-1234).<br>We will then allow you to
                        reset your password.
                    </p>
                </div>
                <div class="mt-8 text-center">
                ...
                <form method="POST" action="{{ route('student.password.reset') }}" class="mt-10">
                    @csrf
                    ...
                    <div class="mb-3">
                        <label for="phone" class="inline-block mb-2 text-base font-medium">Last four digits of your
                            registered phone number</label>
                        <input type="text" id="phone" name="phone" value="{{ old('phone') }}"
                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                            placeholder="Enter the last four digits of your phone number" required autofocus>
                    ...
                    <div class="mb-0">
                        ...
                        <!-- Display Validation Error Messages for Email -->
                        <x-input-error :messages="$errors->get('new_password')" class="mt-2 text-sm text-red-500" />
                    </div>
                    <div class="flex gap-4 mb-3 flex-col-2 md:flex-row">
                        <span class="text-base font-small text-sky-600">
                            Password should be at least 8 characters long and include a combination of alphabetic characters.
                        </span>
                    </div>
                    ...
                    <div class="mt-10">
                        <button type="submit" id="resetPasswordBtn"
                            ...
                            <span id="btnLoader" class="hidden inline-block w-4 h-4 ml-2 align-middle border-2 border-white rounded-full animate-spin border-t-transparent"></span>
                        </button>
                    </div>
                </form>
