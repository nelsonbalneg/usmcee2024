                ...
                <div class="w-full">
                    ...
                    @if ($studentProfile && !$studentProfile->applicant_profile_status && $studentProfile->prereg_status == 'pending')
                        <p class="mb-4 text-sm leading-relaxed text-slate-600">
                            Your applicant profile is not yet complete.
                            Please complete and publish your profile to proceed with your application.
                        </p>
            ...
            <div class="flex gap-3 p-4 mt-3 border border-yellow-200 rounded-md bg-yellow-50">
                ...
                <div class="w-full">
                    ...
                    @if ($blockType === 'profile')
                        ...
                        @endif
                    @elseif ($blockType === 'requirements')
                        <p class="mb-4 text-sm leading-relaxed text-slate-600">
                            Please upload the necessary requirements to continue your application.
                        </p>
