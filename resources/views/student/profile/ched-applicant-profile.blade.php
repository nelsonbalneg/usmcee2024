...
@section('title')
    USMCEE - Applicant Personal Information
@endsection
    ...
    <div class="grid grid-cols-1 xl:grid-cols-12 gap-x-5">
        ...
        <div class="xl:col-span-12">
            ...
            <form action="{{ route('student.ched-applicant-profile.store') }}" id="applicant-form" method="POST">
                ...
                @php
                    $alertTypes = [
                        'success' => ['color' => 'orange', 'message' => session('success')],
                        'error' => [
                            'color' => 'red',
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {{-- <h6 class="mb-4 text-blue-500 uppercase text-15"><i data-lucide="user"
                                class="inline-block text-blue-500 size-4 dark:text-zink-200"></i> ADDITIONAL PERSONAL
                            INFORMATION
                        </h6> --}}
                        ...
                        <div class="grid grid-cols-1 gap-5 lg:grid-cols-2 xl:grid-cols-12">
                            ...
                            <div class="xl:col-span-6">
                                ...
                                <select
                                    ...
                                    name="student_category" id="student_category" data-choices data-choices-search-false>
                            ...
                            <div class="xl:col-span-3">
                                <label for="citizenship" class="inline-block mb-2 text-base font-medium">Citizenship<sup
                                        class="text-red-500">*
                                        required</sup></label>
                                <select
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                            ...
                            <div class="xl:col-span-6">
                                <label for="first_generation_student" class="inline-block mb-2 text-base font-medium">Are
                                    you
                            ...
                            <div class="xl:col-span-3" id="is_4ps_beneficiary">
                                ...
                                <select
                                    ...
                                    <option value="">Select</option>
                                    <option value="1" {{ $applicant->is_4ps_beneficiary == '1' ? 'selected' : '' }}>
                                        Yes</option>
                                    <option value="0" {{ $applicant->is_4ps_beneficiary == '0' ? 'selected' : '' }}>
                                        No</option>
                                </select>
                            </div><!--end col-->
                            ...
                            <div class="xl:col-span-3">
                                ...
                                <select
                                    ...
                                    <option value="">Select</option>
                                    <option value="1" {{ $applicant->is_rebel_returnee == '1' ? 'selected' : '' }}>
                                        Yes</option>
                                    <option value="0" {{ $applicant->is_rebel_returnee == '0' ? 'selected' : '' }}>No
                                    </option>
                                </select>
                            </div><!--end col-->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="grid grid-cols-1 gap-5 lg:grid-cols-2 xl:grid-cols-12">
                            ...
                            <div class="xl:col-span-4">
                                <label for="father_citizenship" class="inline-block mb-2 text-base font-medium">Father's
                                    Citizenship</label>
                                <select
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                            ...
                            <div class="xl:col-span-4">
                                ...
                                <select
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                    name="father_highest_educational_attainment" data-choices data-choices-search-false>
                                    <option value="">Select</option>
                                    <option value="0"
                            ...
                            <div class="xl:col-span-4">
                                <label for="father_employment_status" class="inline-block mb-2 text-base font-medium">What
                            ...
                            <div class="xl:col-span-4">
                                <label for="mother_citizenship" class="inline-block mb-2 text-base font-medium">Mother's
                                    Citizenship</label>
                                <select
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                            ...
                            <div class="xl:col-span-4">
                                ...
                                <select
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                    name="mother_highest_educational_attainment" data-choices data-choices-search-false>
                                    <option value="">Select</option>
                                    <option value="0"
                            ...
                            <div class="xl:col-span-4">
                                <label for="mother_employment_status" class="inline-block mb-2 text-base font-medium">What
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="grid grid-cols-1 gap-5 lg:grid-cols-2 xl:grid-cols-12">
                            ...
                            <div class="xl:col-span-4">
                                <label for="last_school_year_attended" class="inline-block mb-2 text-base font-medium">
                    ...
                    if (result.isConfirmed) {
                        ...
                        fetch("{{ route('student.cee.ched-applicant-profile.publish') }}", {
                            ...
                            .then(data => {
                                if (data.success) {
                                    Swal.fire("Success!",
                                            "Your Additional Information has been published successfully. You can now reserve a slot in USMCEE",
                                            "success")
