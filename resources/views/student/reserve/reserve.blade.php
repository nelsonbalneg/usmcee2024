                                        ...
                                        <tr
                                            ...
                                            <td class="px-3.5 py-2.5">
                                                ...
                                                @else
                                                    ...
                                                    @else
                                                        <span
                                                            class="flex items-center justify-center transition-all duration-200 ease-linear cursor-not-allowed pointer-events-none bg-slate-100 text-slate-500 btn dark:bg-green-500/20 dark:text-slate-400">
                                                            Result Unavailable
                                                        </span>
                                                    @endif
                                                @endif
                                            ...
                                            <td class="px-3.5 py-2.5">
                                                @if ($data->status === 'pending')
                                                    <span
                                                        ...
                                                        <i data-lucide="circle-dashed" class="size-3 ltr:mr-1 rtl:ml-1"></i>
                                                        Reserved
                                                    </span>
                                                @elseif ($data->status === 'cancelled')
                                                    <span
                                                        ...
                                                        <i data-lucide="x-circle" class="size-3 ltr:mr-1 rtl:ml-1"></i>
                                                        Cancelled
                                                    </span>
