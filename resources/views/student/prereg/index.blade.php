            ...
            <div class="grid grid-cols-1 xl:grid-cols-12 gap-x-5">
                ...
                <div class="xl:col-span-6">
                    <div class="card sticky top-[calc(theme('spacing.header')_*_1.3)]">
                        <div class="card">
                            <div class="card-body">
                                <h6 class="mb-4 uppercase text-15">Enrollment Process for incoming Freshmen (1st Semester,
                                    A.Y.
                                    2025-2026 )</h6>
                                <div>
                                    <div
                                        ...
                                        <div class="relative flex gap-2">
                                            ...
                                            <div>
                                                ...
                                                <p class="mb-2 text-slate-500 dark:text-zink-200">Confirmation of Enrollment
                                                    for
                                    ...
                                    <div
                                        ...
                                        <div class="relative flex gap-2">
                                            ...
                                            <div>
                                                ...
                                                <p class=" text-slate-500 dark:text-zink-200">Submission of original copies
                                                    of
