    ...
    <div class="mb-0 border-none shadow-none lg:w-[500px] card bg-white/70 dark:bg-zink-500/70">
        <div class="!px-10 !py-12 card-body">
            ...
            <div class="mt-8 text-center">
                ...
                <p class="mb-6 text-slate-500 dark:text-zink-200">We are currently preparing for the upcoming USMCEE Registration for {{ $active_cee_term->name }}. Our system is temporarily unavailable while we perform necessary updates.<br> Thank you for your patience and understanding.</p>
                <a href="#"
                    class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20"><i
                        ...
                        class="align-middle">Refresh</span></a>
            </div>
        </div>
    </div>
