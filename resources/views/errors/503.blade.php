    ...
    <div class="mb-0 border-none shadow-none lg:w-[500px] card bg-white/70 dark:bg-zink-500/70">
        <div class="!px-10 !py-12 card-body">
            ...
            <div class="mt-8 text-center">
                ...
                <p class="mb-6 text-slate-500 dark:text-zink-200">Our technical team is actively working to enhance the system. We expect to be back online by 9:00 AM on April 23, 2025. Thank you for your patience and understanding.</p>
