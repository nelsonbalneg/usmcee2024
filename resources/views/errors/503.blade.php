    ...
    <div class="mb-0 border-none shadow-none lg:w-[500px] card bg-white/70 dark:bg-zink-500/70">
        <div class="!px-10 !py-12 card-body">
            ...
            <div class="mt-8 text-center">
                ...
                <p class="mb-6 text-slate-500 dark:text-zink-200"> We are currently preparing and processing the results
                    for the upcoming USMCEE {{ $active_cee_term->name }}.
                    Our system is temporarily unavailable while we perform necessary updates.<br>
