...
/**
 * QualifiedRealCampusView Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class QualifiedRealCampusView implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'QualifiedRealCampusView';
    ...
    protected static $openAPITypes = [
        ...
        'tenant_id' => 'int',
        'campus_name' => 'string',
        'qualified_programs' => '\OpenAPI\Client\Model\QualifiedProgramsView[]'
    ];
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\QualifiedProgramsView[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\QualifiedProgramsView[]|null $qualified_programs qualified_programs
     *
     * @return self
     */
    public function setQualifiedPrograms($qualified_programs)
    {
        if (is_null($qualified_programs)) {
            array_push($this->openAPINullablesSetToNull, 'qualified_programs');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('qualified_programs', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
