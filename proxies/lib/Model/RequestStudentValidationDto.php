...
/**
 * RequestStudentValidationDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RequestStudentValidationDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestStudentValidationDto';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('cor_number', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['cor_number'];
    }

    /**
     * Sets cor_number
     *
     * @param int|null $cor_number cor_number
     *
     * @return self
     */
    public function setCorNumber($cor_number)
    {
        if (is_null($cor_number)) {
            throw new \InvalidArgumentException('non-nullable cor_number cannot be null');
        }
        $this->container['cor_number'] = $cor_number;
