...
class ChedApplicantProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'father_highest_educational_attainment' => 'required|string',
            'father_employment_status' => 'required|string',
            'father_occupation' => 'required|string',

            'mother_name' => 'required|string',
            'mother_age' => 'required|string',
            'mother_citizenship' => 'required|string',
            'mother_highest_educational_attainment' => 'required|string',
            'mother_employment_status' => 'required|string',
